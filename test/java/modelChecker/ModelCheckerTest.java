...
public class ModelCheckerTest {
    ...
    public void buildAndCheckModel() {
        try {
            Model model = Model.parseModel("test/resources/model1.json");

            StateFormula fairnessConstraint = new FormulaParser("test/resources/constraint1.json").parse();
            StateFormula query = new FormulaParser("test/resources/ctl1.json").parse();
